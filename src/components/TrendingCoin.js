      ...
      {data ? (
        <>
          <h3 className="txt-base flex items-center my-0.5">
            ...
            <span className="text-[#6b4de6]">{data.name}</span>
            <img
              src={data.small}
              alt={data.name}
          ...
          <h3 className="txt-base flex items-center my-0.5">
            ...
            <span className="text-[#6b4de6]">{data.market_cap_rank}</span>
          </h3>
          <h3 className="txt-base flex items-center my-0.5">
            <span className="text-gray-400 capitalize">
              price (in btc):&nbsp;
            </span>
            <span className="text-[#6b4de6]">
          ...
          <h3 className="txt-base flex items-center my-0.5">
            <span className="text-gray-400 capitalize">score:&nbsp;</span>
            <span className="text-[#6b4de6]">{data.score}</span>
          </h3>
...
"
        ...
        >
          <div
            className="w-8 h-8 border-4 border-[#6b4de6] rounded-full
